...
export 'advanced_search_model.dart';
...
class _AdvancedSearchWidgetState extends State<AdvancedSearchWidget>
  ...
  late AdvancedSearchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdvancedSearchModel());

...
class ResourceViewWidget extends StatefulWidget {
  const ResourceViewWidget({super.key});

  @override
  State<ResourceViewWidget> createState() => _ResourceViewWidgetState();
}

class _ResourceViewWidgetState extends State<ResourceViewWidget> {
  late ResourceViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ResourceViewModel());

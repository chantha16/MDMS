...
import 'c_device_listfor_search_model.dart';
export 'c_device_listfor_search_model.dart';

class CDeviceListforSearchWidget extends StatefulWidget {
  const CDeviceListforSearchWidget({
    super.key,
    this.actionMore,
    this.deviceId,
    this.type,
  ...
  @override
  State<CDeviceListforSearchWidget> createState() =>
      _CDeviceListforSearchWidgetState();
}

class _CDeviceListforSearchWidgetState
    extends State<CDeviceListforSearchWidget> {
  late CDeviceListforSearchModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CDeviceListforSearchModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().storeJsonData = (_model.getalldevices?.jsonBody ?? '');
      safeSetState(() {});

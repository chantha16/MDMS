...
class FilterdatecomponentWidget extends StatefulWidget {
  const FilterdatecomponentWidget({
    super.key,
    this.deviceId,
    this.jsonLabel,
    this.startTime,
  ...
  final int? deviceId;
  final JsonLabelStruct? jsonLabel;
...
class _FilterdatecomponentWidgetState extends State<FilterdatecomponentWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apigetforfilter = await DevicesGroup.readDeviceByIdCall.call();

      if ((_model.apigetforfilter?.succeeded ?? true)) {
        FFAppState().deviceModel = (getJsonField(
          (_model.apigetforfilter?.jsonBody ?? ''),
          r'''$.Device''',
          true,
        )!
                .toList()
                              ...
                              children: [
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      FFAppState().dStartDate =
                                          (String startDate) {
                                        return startDate + "T00:00:00.000+07";
                                      }(dateTimeFormat(
                                        "yyyy-MM-dd",
                                        _model.datePicked1,
                                      ...
                                      final _datePicked1Date =
                                        ...
                                        context: context,
                                        initialDate: functions.getCurrentDate(),
                                ...
                                MouseRegion(
                                  ...
                                  child: InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      FFAppState().dEndDate = (String endDate) {
                                        return endDate + "T23:59:59.999+07";
                                      }(dateTimeFormat(
                                        "yyyy-MM-dd",
                                        _model.datePicked2,
                                        locale: FFLocalizations.of(context)
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    FFAppState().dEndDate = (String startDate) {
                                      return startDate + "T00:00:00.000+07";
                                    }(dateTimeFormat(
                                      "yyyy-MM-dd",
                                      _model.datePicked2,
                                    ...
                                    safeSetState(() {});
                                    _model.apiReadMetricsIdv1 =
                                        await DevicesGroup
                                            .readDeviceMetricsByIdCall
                                            .call(
                                      startDate: FFAppState().dStartDate,
                                      endDate: FFAppState().dEndDate,
                                    );

                                    FFAppState().storeJsonData = getJsonField(
                                    ...
                                    FFAppState().dMetricsModel = (getJsonField(
                                      ...
                                      true,
                                        ...
                                        .toList()
                                        .cast<MetricsStruct>();
                                    FFAppState().jsonbodyStore = getJsonField(
                                      FFAppState().storeJsonData,
                                      r'''$.DeviceMetrics.Metrics''',
                                    );
                                    FFAppState().update(() {});

...
import 'c_add_list_model.dart';
export 'c_add_list_model.dart';
...
class CAddListWidget extends StatefulWidget {
  ...
  final AddToListStruct? dataDetailsSpec;
...
class _CAddListWidgetState extends State<CAddListWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.validateSpecialDayDetail = true;
      if (_model.formKey.currentState == null ||
          !_model.formKey.currentState!.validate()) {
        safeSetState(() => _model.validateSpecialDayDetail = false);
        return;
      }
      if (_model.datePicked1 == null) {
        _model.validateSpecialDayDetail = false;
        safeSetState(() {});
        return;
      }
    });
    ...
    _model.nameTextController ??=
        TextEditingController(text: widget.dataDetailsSpec?.url);
          ...
          child: Row(
            ...
            children: [
                      ...
                      children: [
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              ...
                              onChanged: (_) => EasyDebounce.debounce(
                                ...
                                () async {
                                  FFAppState()
                                      .updateItemSpecialDayDetialsAtIndex(
                                    widget.itemIndex!,
                                    (e) => e
                                      ..startDate =
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            ...
                            safeSetState(() {
                              _model.addateTextController1?.text =
                                  dateTimeFormat(
                                "yyyy-MM-dd",
                                _model.datePicked1,
                                locale:
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            ...
                            safeSetState(() {
                              _model.addateTextController2?.text =
                                  dateTimeFormat(
                                "yyyy-MM-dd",
                                _model.datePicked2,
                                locale:
              ...
              InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  FFAppState().removeAtIndexFromItemSpecialDayDetials(
                      widget.itemIndex!);
                  FFAppState().update(() {});
                },
                child: Icon(

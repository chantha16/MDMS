...
import 'c_device_list_widget.dart' show CDeviceListWidget;
import 'package:flutter/material.dart';

class CDeviceListModel extends FlutterFlowModel<CDeviceListWidget> {
  ...
  // Stores action output result for [Backend Call - API (Read All Devices)] action in cDeviceList widget.
  ...
  // Stores action output result for [Backend Call - API (Read All Devices)] action in textSearch widget.
  ApiCallResponse? apigetalldevice;

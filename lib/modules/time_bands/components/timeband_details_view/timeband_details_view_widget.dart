...
class TimebandDetailsViewWidget extends StatefulWidget {
  const TimebandDetailsViewWidget({super.key});

  @override
  State<TimebandDetailsViewWidget> createState() =>
      _TimebandDetailsViewWidgetState();
}

class _TimebandDetailsViewWidgetState extends State<TimebandDetailsViewWidget> {
  late TimebandDetailsViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TimebandDetailsViewModel());

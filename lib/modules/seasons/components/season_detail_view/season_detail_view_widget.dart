...
import 'season_detail_view_model.dart';
export 'season_detail_view_model.dart';

class SeasonDetailViewWidget extends StatefulWidget {
  const SeasonDetailViewWidget({
    super.key,
    required this.type,
    this.seasonId,
  });
  ...
  @override
  State<SeasonDetailViewWidget> createState() => _SeasonDetailViewWidgetState();
}

class _SeasonDetailViewWidgetState extends State<SeasonDetailViewWidget> {
  late SeasonDetailViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SeasonDetailViewModel());
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'zgd68vgy' /* Please choose month range. */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodySmall
                          ...
                          child: PrimaryButtonWidget(
                            ...
                            btAction: () async {
                              ...
                              if (widget.type == Flag.Add) {
                                ...
                                _shouldSetState = true;
                                if (!(_model.apiResultxsds?.succeeded ??
                                    true)) {
                                  await action_blocks.handleExceptions(
                                    context,
                                    message: valueOrDefault<String>(
                                      getJsonField(
                                        (_model.apiResultxsds?.jsonBody ?? ''),
                                        r'''$.error''',
                                      )?.toString(),
                                      '-',
                                    ),

...
import '/modules/notifications/custom_columns_alert/custom_columns_alert_widget.dart';
...
class _EventViewWidgetState extends State<EventViewWidget>
  ...
  void initState() {
    ...
    _model.tpMainTapController = TabController(
      vsync: this,
      length: 2,
      initialIndex: 0,
                      ...
                      children: [
                        Align(
                          ...
                          child: TabBar(
                            ...
                            controller: _model.tpMainTapController,
                            onTap: (i) async {
                              [() async {}, () async {}][i]();
                            },
                          ),

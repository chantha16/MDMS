...
class ItemSpecialDayDetialsModel
  ...
  // Stores action output result for [Validate Form] action in ItemSpecialDayDetials widget.
  ...
  String? _addateTextController1Validator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'eh21va4y' /* StartDate is required */,
      );
    }

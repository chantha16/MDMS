...
import 'special_day_view_model.dart';
export 'special_day_view_model.dart';

class SpecialDayViewWidget extends StatefulWidget {
  const SpecialDayViewWidget({
    super.key,
    this.type,
    this.types,
    this.details,
  ...
  @override
  State<SpecialDayViewWidget> createState() => _SpecialDayViewWidgetState();
}

class _SpecialDayViewWidgetState extends State<SpecialDayViewWidget> {
  late SpecialDayViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SpecialDayViewModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResultAddSpecialDay =
          await SpecialDayDetailsGroup.specialDayDetailIdCall.call(
        id: widget.specialDayId,
      );

      if ((_model.apiResultAddSpecialDay?.succeeded ?? true)) {
        _model.specialDayDetail = (getJsonField(
          (_model.apiResultAddSpecialDay?.jsonBody ?? ''),
          r'''$.SpecialDayDetail''',
          true,
        )!
                .toList()
        ...
        safeSetState(() {
          _model.nameTextController?.text =
              _model.specialDayDetail.lastOrNull!.specialDayId;
        });
        safeSetState(() {
          _model.startdateTextController?.text =
              _model.specialDayDetail.lastOrNull!.startDate;
        });
        safeSetState(() {
          _model.endateTextController?.text =
              _model.specialDayDetail.lastOrNull!.endDate;
        });
        safeSetState(() {
          _model.descriptionTextController?.text =
              _model.specialDayDetail.lastOrNull!.description;
        });
      }
    });
              ...
              Text(
                () {
                  if (widget.type == Flag.Add) {
                    ...
                    return 'Delete';
                  } else if (widget.type == Flag.AddSub) {
                    return 'Add Holiday';
                  } else {
                    return 'View Holiday';
                  }
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      if ((widget.type == Flag.Update) ||
                                          ...
                                          (widget.type == Flag.AddSub)) {
                                        final _datePicked1Date =
                                            await showDatePicker(
                                          context: context,
                                          initialDate: getCurrentTimestamp,
                                          firstDate: DateTime(1900),
                                          lastDate: (_model.datePicked2 ??
                                              DateTime(2050)),
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        border: Border.all(
                                          color: _model.isPickStartDate == true
                                              ? FlutterFlowTheme.of(context)
                                                  .error
                                              : FlutterFlowTheme.of(context)
                                                  .alternate,
                                  ...
                                  if (_model.isPickStartDate == true)
                                    Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          '6yw2ewr0' /* Please input Start date */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Inter',
                                              color: Color(0xFFE16765),
                                              fontSize: 11.0,
                                              letterSpacing: 0.0,
                                              fontWeight: FontWeight.w500,
                                            ),
                                ...
                                children: [
                                  ...
                                  if (_model.isPickEndDate == true)
                                    Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'hx3pyeke' /* Please input End date */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                        ...
                        child: PrimaryButtonWidget(
                          ...
                          btAction: () async {
                            ...
                            if (widget.type == Flag.Update) {
                              ...
                              _model.apiResult68v = await SpecialDayDetailsGroup
                                ...
                                description:
                                    _model.descriptionTextController.text,
                                startDate: _model.startdateTextController.text,
                              ...
                              _model.apiResult7ag = await SpecialDayDetailsGroup
                              ...
                              context.safePop();
                              FFAppState().addToItemSpecialDayDetials(
                                  SpecialDayDetailsModelStruct(
                                specialDayId: _model.nameTextController.text,
                              ...
                              if (_model.apiResultCreate?.succeeded ?? true) {
                                _model.apiResultCreate?.streamedResponse?.stream

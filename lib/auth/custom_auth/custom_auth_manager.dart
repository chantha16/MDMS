...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    mDMSUIAutomateTestAuthUserSubject.add(
      MDMSUIAutomateTestAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MDMSUIAutomateTestAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MDMSUIAutomateTestAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MDMSUIAutomateTestAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    mDMSUIAutomateTestAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
  ...
  Future initialize() async {
    ...
    try {
      ...
      userData = _prefs.getString(_kUserDataKey) != null
          ? GetProfileResponseModelStruct.fromSerializableMap(
...
MDMSUIAutomateTestAuthUser? currentUser;
